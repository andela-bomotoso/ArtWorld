...
/**
 * Created by bukola_omotoso on 06/06/16.
 */
public class ArtWorldView extends View {
    ...
    public ArtWorldView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void saveImage() {
        final String name = "Artworld" + System.currentTimeMillis() + ".jpg";

        String location = MediaStore.Images.Media.insertImage(getContext().getContentResolver(), bitmap, name, "Artworld Drawing");
    ...
    public void printImage() {
        if (PrintHelper.systemSupportsPrint()) {
            ...
            printHelper.printBitmap("Artworld Image", bitmap);
        } else {
